...
import { definePlugin, SERVER_PLUGIN_ROUTE_META_KEY } from '../../plugin'
import type { RouteMeta, ServerPlugin } from '../../plugin'
import { VALIDATE_META_KEY } from '../validate/middleware'
import type { ValidateMeta } from '../validate/middleware'
import type { JsonSchema } from '../validate/adapter'
