...
export const isEmpty: (s: string) => boolean = /* @__PURE__ */ (() => {
  const _f: any = function isEmpty(s: any) {
    return s === ''
  }
  _f._op = 57
  return _f
...
export const length: (s: string) => number = /* @__PURE__ */ (() => {
  const _f: any = function length(s: any) {
    return s.length
  }
  _f._op = 56
  return _f
...
export const trim: (s: string) => string = /* @__PURE__ */ (() => {
  const _f: any = function trim(s: any) {
    return s.trim()
  }
  _f._op = 50
  return _f
...
export const trimStart: (s: string) => string = /* @__PURE__ */ (() => {
  const _f: any = function trimStart(s: any) {
    return s.trimStart()
  }
  _f._op = 53
  return _f
...
export const trimEnd: (s: string) => string = /* @__PURE__ */ (() => {
  const _f: any = function trimEnd(s: any) {
    return s.trimEnd()
  }
  _f._op = 54
  return _f
...
export const toLowerCase: (s: string) => string = /* @__PURE__ */ (() => {
  const _f: any = function toLowerCase(s: any) {
...
export const toUpperCase: (s: string) => string = /* @__PURE__ */ (() => {
  const _f: any = function toUpperCase(s: any) {
