...
} = function pick<T extends object, const K extends readonly (keyof T)[]>(selected: any, __df?: any): any {
  if (arguments.length >= 2) return pick(__df)(selected)
  return ((value) => {
...
} = function omit<T extends object, const K extends readonly (keyof T)[]>(omitted: any, __df?: any): any {
  if (arguments.length >= 2) return omit(__df)(omitted)
  return ((value) => {
...
} = function assoc<T extends object, K extends PropertyKey, V>(key: any, replacement?: any, __df?: any): any {
  if (arguments.length >= 3) return assoc(replacement, __df)(key)
  return ((value) => {
...
} = function dissoc<T extends object, K extends keyof T>(key: any, __df?: any): any {
  if (arguments.length >= 2) return dissoc(__df)(key)
  return ((value) => {
  const output = Object.create(Object.getPrototypeOf(value)) as object
...
} = function mapValues<T extends object, B>(f: any, __df?: any): any {
  if (arguments.length >= 2) return mapValues(__df)(f)
  return ((value) => {
    const output = Object.create(null) as object
    for (const key of enumerableKeys(value)) {
...
} = function mapKeys<T extends object, K extends PropertyKey>(f: any, __df?: any): any {
  if (arguments.length >= 2) return mapKeys(__df)(f)
  return ((value) => {
    const output = Object.create(null) as object
    for (const key of enumerableKeys(value)) {
...
} = function pickBy<T extends object>(predicate: any, __df?: any): any {
  if (arguments.length >= 2) return pickBy(__df)(predicate)
  return ((value) => {
    const output = Object.create(null) as object
    for (const key of enumerableKeys(value)) {
      const current = Reflect.get(value, key)
...
export const omitBy: typeof pickBy = function omitBy<T extends object>(predicate: any, __df?: any): any {
  if (arguments.length >= 2) return omitBy(__df)(predicate)
  return ((value) => {
  const output = Object.create(null) as object
  for (const key of enumerableKeys(value)) {
    const current = Reflect.get(value, key)
...
} = function mergeWith<A extends object, B extends object>(right: any, resolve?: any, __df?: any): any {
  if (arguments.length >= 3) return mergeWith(resolve, __df)(right)
  return ((left) => {
...
} = function getPathOrUndefined<T, const P extends PathSegments>(path: any, __df?: any): any {
  if (arguments.length >= 2) return getPathOrUndefined(__df)(path)
  return ((value) => {
  let current: unknown = value
  for (const key of path) {
    if (current === null || (typeof current !== 'object' && typeof current !== 'function')) {
...
export const getPath: {
...
} = function getPath<T, const P extends PathSegments>(a0: any, a1?: any): any {
  ...
  const path = a0
  return ((value) => readPath(value, path) as any) satisfies (data: any) => any
} as any
...
} = function hasPath<T>(path: any, __df?: any): any {
  if (arguments.length >= 2) return hasPath(__df)(path)
  return ((value) => {
  let current: unknown = value
  for (const key of path) {
    if (current === null || (typeof current !== 'object' && typeof current !== 'function')) {
...
} = function setPath<T, const P extends PathSegments>(path: any, replacement?: any, __df?: any): any {
  if (arguments.length >= 3) return setPath(replacement, __df)(path)
  return ((value) =>
    (path.length === 0 ? replacement : updatePath(value, path, () => replacement, false)) as any) satisfies (data: any) => any
} as any
...
} = function modifyPath<T, const P extends PathSegments>(path: any, f?: any, __df?: any): any {
  if (arguments.length >= 3) return modifyPath(f, __df)(path)
  return ((value) =>
    (path.length === 0
      ? f(value as any)
      : updatePath(value, path, (current) => f(current as any), true)) as any) satisfies (data: any) => any
} as any
...
} = function removePath<T>(path: any, __df?: any): any {
  if (arguments.length >= 2) return removePath(__df)(path)
  return ((value) =>
  (path.length === 0 ? value : removePathValue(value, path, 0)) as any) satisfies (data: any) => any
} as any
...
} = function evolve<T extends object>(transformations: any, __df?: any): any {
  if (arguments.length >= 2) return evolve(__df)(transformations)
  return ((value) => {
    const output = cloneEnumerable(value)
