...
export const tail: <A>(arr: readonly A[]) => A[] = /* @__PURE__ */ (() => {
  ...
  _f._op = 34
  return registerTrustedOperator(_f, 34)
})()
...
export const reverse: <A>(arr: readonly A[]) => A[] = /* @__PURE__ */ (() => {
  ...
  _f._op = 36
  return registerTrustedOperator(_f, 36)
})()
...
export const flatten: <A>(arr: readonly A[][]) => A[] = /* @__PURE__ */ (() => {
  const _f: any = function flatten(arr: any) { var out = []
    ...
    return out }
  _f._op = 40
  return registerTrustedOperator(_f, 40)
})()
...
export const uniq: <A>(arr: readonly A[]) => A[] = /* @__PURE__ */ (() => {
  ...
  _f._op = 38
  return registerTrustedOperator(_f, 38)
})()
...
export const take: {
  ...
  if (arguments.length < 2) {
    ...
    _dl._op = 3
    _dl._fn = _a0
    return registerTrustedOperator(_dl, 3, _a0)
  }
...
export const drop: {
  ...
  if (arguments.length < 2) {
    ...
    _dl._op = 4
    _dl._fn = _a0
    return registerTrustedOperator(_dl, 4, _a0)
  }
  const arr = _arg0, n = _arg1
  let len = arr.length
    if (n <= 0) {
