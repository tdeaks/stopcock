...
export const head: <A>(arr: readonly A[]) => A | undefined = /* @__PURE__ */ (() => {
  const _f: any = function head(a: any) {
    return a[0]
  }
  _f._op = 30
  return _f
...
export const last: <A>(arr: readonly A[]) => A | undefined = /* @__PURE__ */ (() => {
  const _f: any = function last(a: any) {
    return a[a.length - 1]
  }
  _f._op = 31
  return _f
...
export const tail: <A>(arr: readonly A[]) => A[] = /* @__PURE__ */ (() => {
  const _f: any = function tail(arr: any) {
    if (arr.length <= 1) {
      return []
    } else {
      return arr.slice(1)
...
export const init: <A>(arr: readonly A[]) => A[] = /* @__PURE__ */ (() => {
  const _f: any = function init(arr: any) {
    let len = arr.length
    if (len <= 1) {
      return []
    } else {
...
export const isEmpty: <A>(arr: readonly A[]) => boolean = /* @__PURE__ */ (() => {
  const _f: any = function isEmpty(arr: any) {
    return arr.length === 0
  }
  _f._op = 33
  return _f
...
export const length: <A>(arr: readonly A[]) => number = /* @__PURE__ */ (() => {
  const _f: any = function length(arr: any) {
    return arr.length
  }
  _f._op = 32
  return _f
...
export const reverse: <A>(arr: readonly A[]) => A[] = /* @__PURE__ */ (() => {
  const _f: any = function reverse(arr: any) {
    var len = arr.length,
      out = new Array(len)
...
export const flatten: <A>(arr: readonly A[][]) => A[] = /* @__PURE__ */ (() => {
  const _f: any = function flatten(arr: any) {
    var out = []
    for (var i = 0; i < arr.length; i++) {
      var inner = arr[i]
...
export const first: <A>(arr: readonly A[]) => A | undefined = /* @__PURE__ */ (() => {
  const _f: any = function first(a: any) {
    return a[0]
  }
  _f._op = 30
  return _f
...
export const uniq: <A>(arr: readonly A[]) => A[] = /* @__PURE__ */ (() => {
  const _f: any = function uniq(arr: any) {
...
export const symmetricDifference: {
  ...
  if (arguments.length >= 2) {
    ...
    if (la + lb < 256) {
      var d1 = [],
        d2 = []
      outer1: for (i = 0; i < la; i++) {
        x = a[i]
        j = lb
        while (j--) {
          if (b[j] === x) continue outer1
        }
        d1.push(x)
      }
      outer2: for (i = 0; i < lb; i++) {
        x = b[i]
        j = la
        while (j--) {
          if (a[j] === x) continue outer2
        }
        d2.push(x)
      }
      var all = d1.length + d2.length
      out = new Array(all)
      for (i = 0; i < d1.length; i++) out[i] = d1[i]
      for (i = 0; i < d2.length; i++) out[d1.length + i] = d2[i]
      if (all < 2) return out
      var r = [out[0]]
      outer3: for (i = 1; i < all; i++) {
        x = out[i]
        j = r.length
        while (j--) {
          if (r[j] === x) continue outer3
        }
        r.push(x)
      }
      return r
...
export const sortAsc: (arr: readonly number[]) => number[] = /* @__PURE__ */ (() => {
  const _f: any = function sortAsc(arr: any) {
...
export const sortDesc: (arr: readonly number[]) => number[] = /* @__PURE__ */ (() => {
  const _f: any = function sortDesc(arr: any) {
...
export const slice: {
  ...
  if (arguments.length >= 3) {
    ...
    let len = arr.length
    let s =
      start < 0 ? (((len + start) | 0) > 0 ? (len + start) | 0 : 0) : start < len ? start : len
...
export const reduceBy: {
  ...
  if (arguments.length >= 4)
    return RS.reduceBy(arguments[0], arguments[1], arguments[2], arguments[3])
  const _a0 = arguments[0]
  const _a1 = arguments[1]
  const _a2 = arguments[2]
