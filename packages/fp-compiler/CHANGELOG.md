...
- [`b1b704b`](https://github.com/tdeaks/stopcock/commit/b1b704b86df245bcec6ff2895c053a29e87362dc) Thanks [@tdeaks](https://github.com/tdeaks)! - Add the `stopcock` bin and its `check` subcommand.
