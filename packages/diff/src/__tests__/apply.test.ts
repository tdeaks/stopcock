...
describe('applyUnsafe', () => {
  it('returns value on success', () => {
    const p = patch([{ op: 'add', path: ['b'], value: 2 }])
    expect(applyUnsafe(p)({ a: 1 })).toEqual({ a: 1, b: 2 })
  })
