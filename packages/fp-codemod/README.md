...
- rewrites `stream` and `dict` package subpaths;
...
- emits explicit errors for removed dual helpers, runtime-JIT, async Result,
  Logic, and old optics migrations that require a design decision rather than
  guessing.
