...
The [Spectral Optimizer](/showcases/spectral-optimizer/) uses the same color
API to derive an accessible palette from optimized audio features and preview it
through CVD lenses.
