...
description: A TypeScript toolkit built around pipe. FP primitives, dates, async tasks, image processing.
template: splash
hero:
  title: stopcock
  tagline: "A TypeScript toolkit built around pipe."
  actions:
    - text: Get Started
...
I love functional programming. There are already perfectly good libraries for it in TypeScript, but I wanted to see if I could beat their benchmarks. Then I thought "that yak could do with a shave". These are the ones that survived.
