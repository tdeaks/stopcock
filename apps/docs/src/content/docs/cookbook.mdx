...
Operations with two or more arguments support both a complete direct call and
a data-last call for `pipe`. The recipes use both forms where each reads best.
