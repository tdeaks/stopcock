      ...
      fx: [
        {
          kind: 'saturator',
          enabled: true,
          params: { drive: 0.72, asymmetry: 0.18, tone: 0.58, mix: 1, output: 1 },
        },
        {
          kind: 'ensembleChorus',
          enabled: true,
          params: { rate: 0.3, depth: 6, mix: 0.45, width: 1, tone: 0.82, noise: 0 },
        },
        {
          kind: 'compressor',
          enabled: true,
          params: { threshold: -28, ratio: 8, attack: 3, release: 90, knee: 6 },
        },
